...
namespace CESI_CSharp_TPChocolatine.Controllers
{
    public class RegionsController : Controller
    {
        ...
        public RegionsController(DefaultContext context)
        {
            _context = context;
        }
        ...
        {
            return View(await _context.Region.OrderBy(m => m.Name).ToListAsync());
        }
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var region = await _context.Region.FirstOrDefaultAsync(m => m.Id == id);
